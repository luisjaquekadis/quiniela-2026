        ...
        for group in groups:
            ...
            if "matches" in fields:
                ...
                for m_val in matches_array:
                    ...
                    if match_obj.get("id", {}).get("stringValue") == "m11":
                        match_obj["realHomeScore"] = {"integerValue": "1"}
                        match_obj["realAwayScore"] = {"integerValue": "3"}
                        updated = True
                    elif match_obj.get("id", {}).get("stringValue") == "m27":
                        match_obj["realHomeScore"] = {"integerValue": "2"}
                        match_obj["realAwayScore"] = {"integerValue": "0"}
                        updated = True
                ...
                if updated:
                    ...
                    print(f"Updated group {group_name} successfully with scores.")
